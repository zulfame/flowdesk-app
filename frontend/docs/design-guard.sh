...
LEGACY='/(Dashboard|Tasks|TaskDetail|TaskForm|Meetings|MeetingDetail|MeetingForm|HelpTickets|Reminders|TimeSchedule|TimeScheduleDetail|Notes|Notifications|Settings)\.jsx'
EXCLUDE="$LEGACY"
