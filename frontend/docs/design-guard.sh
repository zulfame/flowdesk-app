...
LEGACY='/(Dashboard|Tasks|TaskDetail|TaskForm|Meetings|MeetingDetail|MeetingForm|HelpTickets|Calendar|Reminders|TimeSchedule|TimeScheduleDetail|Notes|Notifications|Settings)\.jsx'
EXCLUDE="$LEGACY"
